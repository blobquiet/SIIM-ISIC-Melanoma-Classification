...
global_accumulate_grad_batches = None
global_batch_size = 32
global_backbone = 'inception_resnet_v2'
size = 299
...
trainer = pl.Trainer(
    min_epochs=5,
    accumulate_grad_batches = global_accumulate_grad_batches,
